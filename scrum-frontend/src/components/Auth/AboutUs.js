...
import developerImage from './asset/pic.jpg'; // Importation de votre image
    ...
    <Container maxWidth="lg" style={{ marginTop: '50px' }}>
      <Paper elevation={3} style={{ padding: '30px' }}>
        ...
        <Typography variant="body2" paragraph>
          <strong>Développeur :</strong> Eléve ingénieur en 4eme année Réseaux,Systemes & Services Programmables spécialisé en DevOps/Cloud , à l' <span style={{ color: '#1976d2' }}>ENSA Marrakech</span>.
        </Typography>
        <Typography variant="body2" paragraph>
          <strong>Projet :</strong> <span style={{ fontStyle: 'italic' }}>Scrumify</span> est un Projet de Fin d'Année (PFA) conçu pour améliorer la gestion de projets Scrum. Développé entièrement par moi-même sous la supervision de <span style={{ fontWeight: 'bold' }}>Damir Yassine</span>.
        </Typography>
        <Typography variant="body2" paragraph>
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          <IconButton
            component="a"
            href="https://www.linkedin.com/in/yasser-akasbi-9866a4222/"
            target="_blank"
          ...
          <IconButton
            component="a"
            href="mailto:y.akasbi2506@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
