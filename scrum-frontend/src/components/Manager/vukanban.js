    ...
    const fetchData = async () => {
      ...
      try {
        const [tasksResponse, sprintsResponse, employeesResponse] = await Promise.all([
          axios.get('https://scrumflowpfa.tech/api/manager/tasks', { headers: { Authorization: `Bearer ${token}` } }),
          axios.get('https://scrumflowpfa.tech/api/manager/sprints', { headers: { Authorization: `Bearer ${token}` } }),
          axios.get('https://scrumflowpfa.tech/api/employees', { headers: { Authorization: `Bearer ${token}` } }),
        ]);
