...
export const login = (credentials) => async (dispatch) => {
 ...
 const res = await axios.post('https://scrumflowpfa.tech/api/auth/login', credentials);  
...
export const register = (credentials) => async (dispatch) => {
  try {
    const res = await axios.post('https://scrumflowpfa.tech/api/auth/register', credentials);
